...
function About() {
  return (
    <div>
        ...
        <div className="row">
          <div className="col-12">
            <p className="main-para">
              ...
              odio, a numquam ab officia nesciunt. Eveniet voluptates nulla<br/>
              ...
              nostrum ad mollitia earum voluptas perferendis ullam consequatur<br/><br/>
      ...
      <div className="sec-section mt-4">
        <div className="container">
          <div className="row mt sec-section-row shop-image">
            ...
            <div className="col-7 d-flex flex-column justify-content-center align-items-center">
              ...
              <p className="visit-us-para">
                ...
                staff.
                <br />
                Come and share your love for sneakers now!
              </p>
            </div>
          </div>
        </div>
